...
public class MainScreen extends JFrame implements ActionListener {
	...
	public MainScreen() {
		...
		fileButton = new JButton(Main.getScaledImage("/resources/fileIcon.png", 16, 16));
	...
	public static class AudioButton extends JButton implements ActionListener {
		...
		public AudioButton() {
			microphoneImage = Main.getScaledImage("/resources/microphone.png", 16, 16);
			stopImage = Main.getScaledImage("/resources/stop.png", 16, 16);
